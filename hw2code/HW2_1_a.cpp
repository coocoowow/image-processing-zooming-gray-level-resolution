...
char FileName2NNI[]="2_1_a_NNI.raw";
char FileNamebil[]="2_1_a_bil.raw";
char FileNamebic[]="2_1_a_bic.raw";
...
for(int y=0;y<rowsa-1;y++)
{
	...
	imshow("HW2_1_a_NNI",new_image_NNI);
	imshow("HW2_1_a_bil",new_image_bil);
	imshow("HW2_1_a_bic",new_image_bic);
	cvWaitKey(0);	
